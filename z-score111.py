...
df = pd.read_csv("./csvFiles/C-111/School2.csv")
...
df = pd.read_csv("./csvFiles/C-111/School_1_Sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("./csvFiles/C-111/School_2_Sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("./csvFiles/C-111/School_3_Sample.csv")
data = df["Math_score"].tolist()
